...
2. Summarize the results for the user in simple language:
   ...
   - If FDD is enabled, explain FDD-specific findings: missing QUICK_REF files, cross-feature imports, oversized feature files that should be split, screens with too much business logic
